...
export function TraditionSection() {
  return (
    <section className="flex w-full flex-col items-start justify-center gap-8 px-5 lg:h-[783px] lg:flex-row lg:items-center lg:gap-16 lg:px-[50px]">
      <div className="flex w-full flex-col items-start gap-10 overflow-hidden lg:h-full lg:flex-1 lg:justify-between lg:gap-0">
        <h2 className="w-full text-[32px] tracking-[-0.32px] lg:text-[48px] lg:tracking-[-0.48px]">
          TRADITION,
          <br /> MÉMOIRE & AUDACE,
          <br /> DEPUIS 1862
        </h2>
        <div className="flex w-full flex-col items-start gap-8 lg:flex-row lg:gap-20">
          <p className="shrink-0 text-[18px] tracking-[-0.18px] uppercase">
            savoir-faire
          </p>
          <div className="flex flex-col items-start gap-8 lg:flex-1">
            <p className="text-[18px] tracking-[-0.18px] text-muted">
      ...
      <div className="relative h-[340px] w-full overflow-hidden lg:h-full lg:flex-1">
        <Image
